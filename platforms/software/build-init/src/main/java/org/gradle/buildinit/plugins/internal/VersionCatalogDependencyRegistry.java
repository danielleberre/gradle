...
public class VersionCatalogDependencyRegistry {
    ...
    private static String pluginIdToAlias(String pluginId) {
        ...
        return moduleToAlias(pluginIdComponents[pluginIdComponents.length - 1]);
    }

    private static String artifactToAlias(String module) {
        return moduleToAlias(module.split(":")[1]);
    }
